...
with open('c:/Users/hp/Desktop/SENSEI-hackathon/sensei-frontend/src/app/page.tsx', 'r', encoding='utf-8') as f:
    lines = f.readlines()

new_content = """                  <p style={{ fontSize: '0.82rem', color: '#555', fontWeight: 600 }}>Trusted by <strong style={{ color: PURPLE }}>12,000+</strong> students & faculty</p>
                </div>
              </motion.div>
...
lines = lines[:455] + [new_content + '\n'] + lines[589:]
with open('c:/Users/hp/Desktop/SENSEI-hackathon/sensei-frontend/src/app/page.tsx', 'w', encoding='utf-8') as f:
    f.writelines(lines)
